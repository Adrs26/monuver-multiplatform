...
@Composable
internal actual fun SettingsContent(
    state: SettingsState,
    ...
    if (showAuthenticationPrompt && AuthenticationManager.canAuthenticate(context)) {
        AuthenticationManager.showBiometricPrompt(
            ...
            onAuthSuccess = {
                ...
                onAction(SettingsAction.AuthenticationEnableChange(!state.isAuthenticationEnabled))
            },
            onAuthFailed = { showAuthenticationPrompt = false },
