...
import monuver.feature.saving.generated.resources.save_total_balance
import org.jetbrains.compose.resources.stringResource

@Composable
internal fun SavingBalanceContent(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.save_total_balance),
